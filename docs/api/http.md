...
|                               |  cdbalance                     | createspendauthsig                           |
|    **block**                  |  uncdbalance                   | createshieldnullifier                        |
| getnowblock                   |  uncdasset                     | getshieldtransactionhash                     |
...
|  proposaldelete                  | updateucrlimit       | gettriggerinputforshieldedtrc20contract |
...
JAVA:
[GH stabilaprotocol/wallet-cli/src/main/java/org/stabila/demo/TransactionSignDemo.java#L92](https://github.com/stabilaprotocol/wallet-cli/blob/master/src/main/java/org/stabila/demo/TransactionSignDemo.java#L92)

PHP:
[GH: stabilaprotocol/Documentation/STB_CN/index.php](https://github.com/stabilaprotocol/Documentation/blob/master/STB_CN/index.php)
...
Description: Query the ucr delegation information
```console
...
Parameter fromAddress: Ucr from address, default hexString

Parameter toAddress: Ucr to address, default hexString

Return: Ucr delegation information

- /walletsolidity/getdelegatedresourceaccountindex(Since Odyssey-v3.2)

Description: Query the ucr delegation index by an account
```console
...
'{
   "note": {
       "value": 40,
       "payment_address":"zstabila1768kf7dy4qquefp46szk978d65eeua66yhr4zv260c0uzj68t3tfjl3en9lhyyfxalv4jus30xs",
...
Parameter amount: Transfer STB amount
...
Description: Stake STB
```console
$ curl -X POST http://127.0.0.1:8090/wallet/cdbalance -d
'{
    "owner_address": "41e472f387585c2b58bc2c9bb4492bc1f17342cd1",
    "cded_balance": 10000,
    "cded_duration": 3,
...
Parameter cded_balance: STB stake amount

Parameter cded_duration: STB stake duration, at least 3 days

Parameter resource: STB stake type, 'BANDWIDTH' or 'UCR'
...
Description: Unstake the staked STB that is due
```console
$ curl -X POST http://127.0.0.1:8090/wallet/uncdbalance -d
'{
    "owner_address": "41e472f387585c2b58bc2c9bb4492bc1f17342cd1",
    "resource": "BANDWIDTH",
    "receiver_address": "414332f387585c2b58bc2c9bb4492bc1f17342cd1"
...
Parameter resource: staked STB unstake type 'BANDWIDTH' or 'UCR'
...
```console
$ curl -X POST http://127.0.0.1:8090/wallet/uncdasset -d
'{
    "owner_address": "41e472f387585c2b58bc2c9bb4492bc1f17342cd1"
}'
```
...
Parameter amount: STB transfer amount
...
Parameter fee_limit: The maximum STB burns for resource consumption

Parameter call_value: The STB transfer to the contract for each call
...
Parameter origin_ucr_limit: The maximum resource consumption of the creator in one execution or creation

Parameter permission_id: Optional, for multi-signature use

Return: Transaction object

Note: The unit of STB in the parameters is UNIT
...
- wallet/updateucrlimit

Description: Update the origin_ucr_limit parameter of a smart contract
```console
$ curl -X POST  http://127.0.0.1:8090/wallet/updatesetting -d
'{
    "owner_address": "419844f7600e018fd0d710e2145351d607b3316ce9",
    ...
    "shielded_spends": [
        {
            "note": {
                "value": 500000000,
                "payment_address": "zstabila1jld8fmvujrz2vgkc867zuwklmewy4ypw0wtwgweqs2paee0uhc8f3azy90el770arksa2kunl02",
...
wallet/getburnstb
Description：Get burn stb amount
demo: curl -X get  http://127.0.0.1:8090/wallet/getburnstb
Parameter：  none
Return：burn stb amount
